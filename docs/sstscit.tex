...
\iffalse
  ...
  Heterogeneous computing usually refers to processor-level 
  ...
  SSTSCIT aims to provide the capability to interoperate the two systems without interfering with
  any of the kernels by concealing the communication protocols in black box interfaces.

  4. What you found (your results)
  This project provides a demonstration of the interoperability by simulating a traffic
  intersection, where the traffic lights are determined by SystemC processes.
