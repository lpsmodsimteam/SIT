...
\begin{lstlisting}[language=C++, caption={Snippet of \texttt{parent\_sst.cpp}}, captionpos=b]
...
\begin{lstlisting}[language=C++, caption={Snippet of \texttt{blackboxes/demo.cpp}}, captionpos=b]
