...
\iffalse
  ...
  provide interoperability between SST and SystemC.

  3. What you actually did (your procedure or experimental method)

  SSTSCIT aims to achieve this capability in a modular design without interfering with the kernels
  by concealing the communication protocols in black box interfaces.

  4. What you found (your results)

  This project includes a demonstration of the interoperability by simulating a traffic intersection
  with traffic lights driven by SystemC processes.
  ...
  The modular implementation of the black box interface allowed for sufficient flexibility in
  establishing communication between the different systems. This design can, therefore, be
  configured to interoperate SST with various model simulation frameworks and even hardware to
  achieve further heterogeneity.
