...
% I took a look at your white paper, and overall it looks good. I have one suggestion, could you describe the interface in more detail? The diagrams are very useful, but maybe add some more detail about using message pack to compress the data, how you could use the generic structure for various languages besides systemc, etc. Possibly also some details of what the boilerplate black box provides. I also have one tiny change, my email doesn’t have a ‘y’ in it. Section 4 to me looks very good, I like all the diagrams and it seems well documented.