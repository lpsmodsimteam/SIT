...
\begin{document}
  ...
  \section{Communication}
    ...
    \lstinline{sigutils::SignalIO} with customized sending and receiving methods. Named pipes and
    shared memories are possible IPC methods that can be implemented into the black box interface.
