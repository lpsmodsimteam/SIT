...
void traffic_light_fsm::handle_event(SST::Event *ev) {
    ...
    if (se) {
        ...
        m_signal_io.set(traffic_light_fsm_ports::load, std::stoi(_data_in.substr(2, 1)));
        m_signal_io.set(traffic_light_fsm_ports::start_green, std::stoi(_data_in.substr(3, 1)));
        m_signal_io.set(traffic_light_fsm_ports::green_time, std::stoi(_data_in.substr(4, 2)));
        m_signal_io.set(traffic_light_fsm_ports::yellow_time, std::stoi(_data_in.substr(6, 1)));
        m_signal_io.set(traffic_light_fsm_ports::red_time, std::stoi(_data_in.substr(7, 2)));
        m_signal_io.set(traffic_light_fsm_ports::_clock, std::stoi(_data_in.substr(9)));
        ...
        std::string _data_out = std::to_string(m_signal_io.get<int>(traffic_light_fsm_ports::state));
